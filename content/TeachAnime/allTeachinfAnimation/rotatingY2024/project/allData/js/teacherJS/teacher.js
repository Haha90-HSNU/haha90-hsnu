...
var world3D={};
world3D.cameraRR=20;
world3D.cameraTheta=world3D.cameraThetaTarget=80*Math.PI/180;
world3D.cameraPhi=world3D.cameraPhiTarget=0*Math.PI/180;
//Three.js
world3D.scene = new THREE.Scene();
var scene = world3D.scene;
world3D.camera = new THREE.PerspectiveCamera( 45/2, 1600 / 900, 1, 100000 );
...
function myMouseMove(e){
	if(world3D.camera.isDraging && world3D.cameraDragAndRotate){
		...
		while(world3D.cameraPhiTarget>Math.PI){world3D.cameraPhiTarget-=2*Math.PI;world3D.cameraPhi-=2*Math.PI;}
		while(world3D.cameraPhiTarget<-Math.PI){world3D.cameraPhiTarget+=2*Math.PI;world3D.cameraPhi+=2*Math.PI;}
...
world3D.render = function() {
	//設定攝影機位置
	world3D.cameraRR=(0.92*world3D.cameraRR+0.08*world2D.slCameraRR.value);

	let cameraPhiTarget=Math.round(world3D.cameraPhiTarget/(10*Math.PI/180))*(10*Math.PI/180);
	let cameraThetaTarget=Math.round(world3D.cameraThetaTarget/(5*Math.PI/180))*(5*Math.PI/180);
	
	world3D.cameraTheta=0.92*world3D.cameraTheta+0.08*cameraThetaTarget;
	world3D.cameraPhi=0.92*world3D.cameraPhi+0.08*cameraPhiTarget;
